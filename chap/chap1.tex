\chapter{使用介绍}
	...
	\begin{itemize}\denseenum
		\item \verb|cumtb.cls|：cumtb~文档类的类文件。
		\item \verb|cumtb.def|：在~\verb|cumtb.cls|~中使用的定义文件。
		...
		\begin{itemize}\denseenum
			...
			\item \verb|pkulogo.ps|：中国矿业大学校徽。
			\item \verb|pkuword.ps|：“中国矿业大学（北京）”字样。
		\end{itemize}
	\end{itemize}
	...
	{\ 感谢曹东刚老师在教学网站提供~GNU make~的下载。}（中国矿业大学校园网）

	为了获得最好的支持，我们建议用户使用最新版的~\LaTeX{}~系统和各宏包。

	\section{编译方式}

	cumtb~文档模板支持三种编译方式，即
	\begin{itemize}\denseenum
	...
	cumtb~文档模板附带的~Makefile~中已经对这三种编译方式进行了完整的配置。
